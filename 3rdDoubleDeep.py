...
def update_target_graph():
    from_vars=tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, "DQNetowk")
...
pretrain_length = batch_size*50   # Number of experiences stored in the Memory when initialized for the first time
    ...
    with tf.Session() as sess:
        ...
        for episode in range(total_episodes):
            ...
            while step < max_steps:
                ...
                Qs_next_state = sess.run(TargetNetwork.output, feed_dict = {DQNetwork.inputs_: next_states_mb})
